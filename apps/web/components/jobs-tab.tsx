    ...
    <div className={`space-y-6 ${className}`} data-testid="jobs-tab-content">
      ...
      <div className="bg-card rounded-lg shadow">
        {isLoading ? (
          ...
          <div
            className="text-center py-12 font-mono px-6"
                    ...
                    <tr key={job.id} className="hover:bg-muted/50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <div className="flex flex-col">
                          <span
                            className={`inline-flex items-center gap-1 ${getStatusColor(job.status)}`}
                          >
                          ...
                          {job.status === "failed" && job.errorMessage && (
                            <span
                              className="text-[10px] text-destructive mt-1 max-w-[150px] truncate font-mono"
